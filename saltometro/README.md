...
- Usar un microcontrolador como teclado Bluetooth.
- Un algoritmo para detectar saltos con un acelerómetro.
- Un sistema de partículas.

## ¿Cómo lo uso?
Échate el dispositivo al bolsillo, o sujétalo al cuerpo con una muñequera o tobillera: lo importante es que no vaya suelto y se mueva con el cuerpo. Conecta la batería o el cable USB, emparéjalo con un ordenador y listo. Puedes usar el sketch de processing para contar los saltos o cualquier otro programa que recoja eventos de teclado.
...
#### ¿Qué puedo configurar?
En la clase `JumpCounter` están los principales parámetros del sistema de partículas: posición, colores, rotación inicial, duración de la partícula...